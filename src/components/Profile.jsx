      ...
      <div className="profile">
        <div className="profile-header">
          ...
          <div className="profile-title">
            {user.isManager ? 'Volunteer Info' : 'My Info'}
          </div>
            ...
            : <div className="profile-content__left">
              ...
              <div className="profile-today">
                ...
                <div className="profile-today-time">
                  <div>Signed In: </div>
                  <div>
                    {moment.unix(user.visits[0].timeIn).format('h:mm a')}
                  </div>
                </div>
                <div className="profile-today-time">
                  <div>Current Hours: </div>
                  <div>
                      +{getHoursDifference(moment.unix(user.visits[0].timeIn), moment())}
                  </div>
                </div>
            ...
            {view === 'bikes' &&
              <div className="bike__container scroll">
                {_.isEmpty(bikesEarned)
                  ? <div className="bike-none">
                    {`${user.isManager ? 'This volunteer has' : 'You have'} not earned any bikes yet.`}
                  </div>
                  : <div>
