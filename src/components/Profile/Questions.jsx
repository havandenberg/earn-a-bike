  ...
  render() {
    ...
    return (
      <div className="profile-question__container scroll">
        ...
        <div className="profile-answer">{selectedUser.questionOne.join(', ')}</div>
        <div className="profile-question">2. Would you like to be added to the volunteer email list?</div>
        <div className="profile-answer">{selectedUser.emailList ? 'Yes' : 'No'}</div>
        <div className="profile-question">3. Are you interested in becoming a shop manager?</div>
        <div className="profile-answer">{selectedUser.isInterestedManager ? 'Yes' : 'No'}</div>
        <div className="profile-question">4. Are you a student?</div>
